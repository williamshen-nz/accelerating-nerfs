...
from accelerating_nerfs.datasets.utils import Rays
...
class SubjectLoader(torch.utils.data.Dataset):
    ...
    def downscale(self, num_downscales: int = 1):
        ...
        # Resize images to new size
        resize = Resize((self.HEIGHT, self.WIDTH))
        images_bchw = resize(self.images.permute(0, 3, 1, 2))
        self.images = images_bchw.permute(0, 2, 3, 1)
        ...
        print(f"Downscaled to {self.WIDTH}x{self.HEIGHT}.")
